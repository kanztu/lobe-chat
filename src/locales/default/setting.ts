export default {
  ...
  'agentCronJobs.agentIdRequired': 'Agent ID is required',
  ...
  'agentCronJobs.fieldsRequired': 'Please fill in all required fields',
  ...
  'agentCronJobs.resetFailed': 'Failed to reset execution counts',
  'agentCronJobs.resetSuccess': 'Execution counts reset successfully',
  'agentCronJobs.save': 'Save',
  'agentCronJobs.saveFailed': 'Failed to save scheduled task',
