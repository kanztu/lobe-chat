export default {
  ...
  'agentCronJobs.confirmClearTopics': 'Delete {{count}} execution results? This cannot be undone.',
  'agentCronJobs.confirmDelete': 'Are you sure you want to delete this scheduled task?',
  'agentCronJobs.confirmDeleteCronJob': 'Delete this scheduled task? All execution results will also be deleted.',
  ...
  'skillStore.empty': 'Browse the skill store. Install one to get started – more can be added later.',
  'skillStore.emptySearch': 'No matching skills found',
